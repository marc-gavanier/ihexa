import { createB2CClientAction } from '@/app/_actions/client/create-client.action';
...
import { CREATE_B2C_CLIENT_ACTION_KEY, CreateClientPage } from '@/features/client/abilities/create-client';

export const generateMetadata: MetadataTranslation = metadataTranslation(i18n)('clients.create');

export default pageBuilder()
  .use(withClientBinder(CREATE_B2C_CLIENT_ACTION_KEY, createB2CClientAction))
